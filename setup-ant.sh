...
# Configure Ant Group internal MCP servers.
# Run this script inside Ant Group network.

########################################
# ANT GROUP MCP LIST (edit here)
########################################
install_ant_mcp_servers() {
    echo "Configuring Ant Group MCP servers from setup-ant.sh..."
